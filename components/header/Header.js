    ...
    <div className="w-full flex items-center relative justify-between p-6 text-red-900 dark:text-green-300">
      <span className="flex items-center">
        <p className="text-2xl sm:text-4xl font-medium text-red-800 rounded-sm px-1">
          ...
          {/* <Image src="/mainlogo.png" alt="main logo" width={60} height={54} className="mr-2" />
          <p>SnapStyle</p> */}
        </p>
      </span>
      <div className="absolute right-6 flex">
        ...
        <a
          ...
          className="flex justify-center items-center p-3 px-6 bg-green-300 text-yellow-900 font-bold rounded-sm shadow-lg hover:shadow-yellow-300/30 sm:hover:scale-[1.02] transition-all ease-in-out duration-100 scale-75 -mr-6 md:mr-0 sm:scale-100 outline-none ring ring-yellow-900 dark:ring-0"
          target="_blank"
          rel="noopener noreferrer"
        >
