...
export default function Resize() {
  ...
  return (
    <>
      ...
      >
        <button className="transform p-3 flex flex-col shadow font-semibold text-xs justify-center items-center rounded-sm bg-sky-300 text-sky-900 ease-in-out duration-200 hover:bg-sky-300/90 group outline-none active:scale-95 ring ring-sky-900 dark:ring-0">
