...
export default function Background({ img }) {
  ...
  return (
    <>
      ...
      >
        <button className="transform p-3 flex flex-col font-semibold text-xs justify-center items-center rounded-sm bg-rose-300 text-rose-900 ease-in-out duration-200 hover:bg-rose-300/90 group outline-none active:scale-95 ring ring-rose-900 dark:ring-0">
