...
export default function Corners() {
  ...
  return (
    <>
      ...
      >
        <button className="transform p-3 flex flex-col font-semibold text-xs justify-center items-center rounded-sm bg-fuchsia-300 text-fuchsia-900 ease-in-out duration-200 hover:bg-fuchsia-300/90 group outline-none active:scale-95 ring ring-fuchsia-900 dark:ring-0">
