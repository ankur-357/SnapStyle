...
export default function Padding() {
  ...
  return (
    <>
      ...
      >
        <button className="transform p-3 flex flex-col font-semibold text-xs justify-center items-center rounded-sm bg-indigo-300 text-indigo-900 ease-in-out duration-200 hover:bg-indigo-300/90 group outline-none active:scale-95 ring ring-indigo-900 dark:ring-0">
