...
export default function Shadow() {
  ...
  return (
    <>
      ...
      >
        <button className="transform p-3 flex flex-col shadow font-semibold text-xs justify-center items-center rounded-sm bg-zinc-300 text-zinc-900 ease-in-out duration-200 hover:bg-zinc-300/90 group outline-none active:scale-95 ring ring-zinc-900 dark:ring-0">
