    ...
    <>
      <div className="fixed bottom-0 w-full flex justify-center z-10 py-5">
        <div className="w-full sm:w-10/12 flex flex-wrap justify-center items-center gap-4">
          ...
          {!img && (
            <button
              className="transform p-4 flex font-semibold text-lg justify-center items-center px-8 rounded-sm bg-green-300 text-yellow-900 ease-in-out hover:bg-green-300/90 group outline-none ring ring-yellow-900 dark:ring-0"
          ...
          {img && (
            <div className="flex gap-4 overflow-x-auto pb-6 pt-2">
              <div className="w-max gap-6 flex h-max px-4">
                <button
                  className="transform p-3 flex flex-col font-semibold text-xs justify-center items-center rounded-sm bg-green-300 text-yellow-900 ease-in-out duration-200 hover:bg-green-300/90 group outline-none active:scale-95 ring ring-yellow-900 dark:ring-0"
                  onClick={() => document.getElementById("file_select").click()}
                >
                  <ArrowUpTrayIcon className="w-7 stroke-[1.5]" />
                  <span className="absolute -bottom-6 opacity-70 group-hover:opacity-100 dark:text-green-300 text-yellow-900">
                    Upload
                  </span>
                </button>
                <CopyClipboard />
